...
setuptools.app.muledump.drawPortrait = function(c, $c) {
    ...
    chtext.append($('<div style="padding-top: 3px;">').text('<span class="' + (c.Seasonal) ? "seasonal" : "" + '">' + cl[0] + '</span> ' + c.Level + ", " + c.muledump.MaxedStats + "/8" + ', #' + c.id)).append($('<div>').text(c.CurrentFame + ' F ' + c.Exp + ' XP'));
