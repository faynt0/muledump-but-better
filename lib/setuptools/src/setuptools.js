...
setuptools.config.appspotProd = document.location.href;
...
setuptools.config.defaultSlotOrder = [42010, 42011, 42012, 1, 2, 3, 17, 8, 24, 5, 16, 12, 13, 18, 22, 15, 20, 11, 19, 21, 4, 23, 25, 27, 28, 29, 7, 6, 14, 9, 42013, 42014, 42015, 42016, 42017, 42018, 42019, 42020, 42021, 42022, 42023, 42024, 42025, 42026, 42027, 42028, 42029, 50000, 10, 26, 0];
...
setuptools.config.mqStaleCache = 43200000;
...
setuptools.config.totalsFilterKeysIndex = 14;
setuptools.config.totalsSaveKeys = ['totalsGlobal', 'famefilter', 'fameamount', 'feedfilter', 'feedpower', 'sbfilter', 'nonsbfilter', 'utfilter', 'stfilter', 'wbfilter', 'forgefilter', 'osancfilter', 'oryxtokenfilter', 'disabled'];
