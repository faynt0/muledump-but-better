...
function update_totals() {
	...
	function isbad(id) {
	    ...
	    if (!options.famefilter && !options.feedfilter && !options.utfilter && !options.sbfilter && !options.stfilter && !options.nonsbfilter && !options.wbfilter && !options.forgefilter ) return false;
